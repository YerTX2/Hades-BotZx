...
if (prohibited.some(word => m.text.toLowerCase().includes(word))) return m.reply('Deja de buscar eso asqueroso humano de razón no kachas.').then(_ => m.react('✖️'))
await m.react('🕓')
try {
